...
class EditProfileFaceDetectionCameraView extends StatefulWidget {
  final CameraLensDirection initialDirection;

  const EditProfileFaceDetectionCameraView({
    Key? key,
  ...
  @override
  State<EditProfileFaceDetectionCameraView> createState() => _EditProfileFaceDetectionCameraViewState();
}

class _EditProfileFaceDetectionCameraViewState extends State<EditProfileFaceDetectionCameraView> {
    ...
    return _enableCapture
      ...
      onPressed: () async {
        try {
          ...
          read.uploadImage(context,File(xFile.path));
